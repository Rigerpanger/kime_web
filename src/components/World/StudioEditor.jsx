...
const FX_TYPES = ['None', 'NeuralAtom', 'NeuralSwarm', 'ShapeShifter', 'SoftwareSilhouette', 'LogicArchitect', 'TetrisReveal', 'Iris', 'HoloGrid', 'NeonEdges', 'QuantumDust', 'CyberWaves', 'DataStream', 'GeoSwarm', 'SacredGeometry', 'SynapseCore', 'MilkyWay', 'Levitation', 'EngineGizmo', 'SpatialAR'];
