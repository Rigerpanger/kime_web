                ...
                <group>
                    {activeFXs.map(fx => {
                        ...
                        switch(fx.type) {
                            ...
                            case 'SynapseCore': return <SynapseCore key={key} config={{...fx, radius: (fx.radius ?? 0.8), scale: fx.scale ?? 1.0, pulseSize: fx.pulseSize ?? 1.0, depth: fx.depth ?? 0}} modelY={modelY + 1.8} />;
