...
5. Чтобы НАЧАТЬ ДОКАПЫВАТЬСЯ по таймеру (Hound Mode): $$HOUND_CREATE: @username | интервал_в_минутах | цель$$
6. Если к тебе обратились явно не по делу: $$IGNORE$$
`;
        ...
        let selectedModel = 'gpt-4o'; // Дефолт для групп и админа
