            ...
            const aiRes = await fetch('https://api.openai-proxy.com/v1/chat/completions', {
                ...
                body: JSON.stringify({ 
                    ...
                    messages: [
                        { 
                            role: 'system', 
                            content: `Ты — Тумба, Elite PM студии KIME. 
Твой стиль: Холодная, "дорогая" ирония топового рекламного агентства. Предельный лаконизм.

Формат отчета:
1. Суть проекта.
2. Заказчик и условия.
3. Мнение Тумбы (10-15 резких слов). 
