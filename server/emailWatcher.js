            ...
            const aiRes = await fetch('https://api.openai-proxy.com/v1/chat/completions', {
                ...
                body: JSON.stringify({ 
                    ...
                    messages: [
                        { 
                            role: 'system', 
                            content: `Ты — Тумба, Elite Project Manager студии KIME. Твой уровень сарказма: 7/10. 
Проанализируй тендер и выдай результат в формате:
1. Краткая суть (что нужно сделать).
2. Кто заказчик и ключевые условия.
3. Раздел "Мнение Тумбы" (твой саркастичный, циничный профессиональный комментарий о тендере, бюджете или заказчике).

Будь лаконична, остра на язык и технична.` 
                        },
